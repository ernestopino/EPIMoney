...
// EPIMoney
#define COCOAPODS_POD_AVAILABLE_EPIMoney
#define COCOAPODS_VERSION_MAJOR_EPIMoney 0
#define COCOAPODS_VERSION_MINOR_EPIMoney 1
#define COCOAPODS_VERSION_PATCH_EPIMoney 0
